...
class Corporation7 extends Corporation
{
  public function __construct($player)
  {
    ...
    $this->desc = clienttranslate(
      'You must regress another tracker each time you claim a milestone from the civ track. Do not claim benefits from regressing.'
    );
  ...
  public function getCivLevel($y = null)
  {
    ...
    return $civLevels[$this->countLevel(CIV, $y)];
  }
  ...
  public function getMoveFromRoverTrack()
  {
    ...
    $bonuses = is_array($this->tracks[ROVER][$roverLevel])
      ? $this->tracks[ROVER][$roverLevel]
      : [$this->tracks[ROVER][$roverLevel]];
