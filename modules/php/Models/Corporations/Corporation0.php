...
class Corporation0 extends Corporation
{
  public function __construct($player)
  {
    ...
    $this->desc = clienttranslate(
      'Advance your trackers to gain benefits, unlock milestones, and score the highest medal your tracker covers or surpasses'
    );
  ...
  {
    return $this->player->hasTech(TECH_CAN_STORE_BIOMASS_PATCH) && Globals::getPhase() != END_OF_GAME_PHASE;
  }
}
